        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-gray-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#1E293B] to-[#0F172A] border border-[#C5A059] flex items-center justify-center text-[#C5A059] font-serif text-xl font-bold">
                Z
              </div>
              <div>
            ...
            <div className="flex items-center space-x-3 pt-3">
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-[#C5A059] hover:border-[#C5A059] transition-all" aria-label="Instagram">
